...
class DeepSeekR1ReasoningParser(ReasoningParser):
    ...
    def extract_reasoning_content_streaming(
        ...
        if len(delta_token_ids) == 1 and delta_token_ids[0] == self.start_token_id:
            return None
        ...
        if self.start_token_id in previous_token_ids:
            if self.end_token_id in delta_token_ids:
                ...
                # reasoning content ends - now we might get the two newlines
                content = self._remove_leading_newlines(delta_text)
            ...
            if self.end_token_id in delta_token_ids:
                ...
                # </think> in previous, thinking content ends - now we might get the two newlines
                content = self._remove_leading_newlines(delta_text)
                return DeltaMessage(content=content)
            else:
